...
// }: ProductCardProps) {  const { wishlistIds, refreshWishlist } = useWishlist();

// const [isFavorite, setIsFavorite] = useState(initialIsFavorite);  
//   const [loadingFavorite, setLoadingFavorite] = useState(false);

//   // تحديث حالة القلب بناءً على الـ wishlist
//   useEffect(() => {
//     setIsFavorite(wishlistIds.includes(product.id));
...
//         const res = await removeProductFromWishlistSer(product.id);
...
//         const res = await addProductToWishlistSer(product.id);
...
export default function ProductCard({
  ...
  // تحديث حالة القلب من الـ wishlist
  useEffect(() => {
